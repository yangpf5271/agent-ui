...
const ChatInput = () => {
  ...
  return (
    <div className="relative mx-auto flex w-full max-w-2xl justify-center gap-x-2">
      <PlaygroundTextArea
        placeholder={
          'Type something...'
        }
        ...
        className="w-full rounded-md border border-border pr-10 text-sm focus:border-border"
